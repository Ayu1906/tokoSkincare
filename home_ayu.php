    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="color:#fff; font-size:30px;">Jual<b>SkinCare.pol</b></a>
        </div>
      ...
      ?>
        ...
        <center><img src="gambar/<?php echo $buku['gambar'] ?>" style="margin-top:20px; width:200px;height:190px;"></center>
         <h3 style="text-align:center; color:#0000ff;"><?php echo $buku['judul'] ?></h3>
          ...
          <center><a class="btn btn-danger" href="detail_ayu.php?id=<?php echo $buku['id_buku'] ?>" role="button" style="margin-top:10px;">View details &raquo;</a></center>
         </div>
        </div>
        <?php } }
        ...
        <h3 style="text-align:center; color:#0000ff; "><?php echo $buku1['judul'] ?></h3>
          ...
          <center><a class="btn btn-danger" href="detail_ayu.php?id=<?php echo $buku1['id_buku'] ?>" role="button" style="margin-top:10px;">View details &raquo;</a></center>
         </div>
        </div>
          <?php }} ?>
      </div>
