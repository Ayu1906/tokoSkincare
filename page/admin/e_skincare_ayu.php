...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			mysqli_query($conn,"UPDATE skincare set nama_produk='$nama_produk',id_ketegori='$id_kategori',pembuat='$pembuat',asal_produk='$asal_produk',isi_produk='$isi_produk',harga='$harga', gambar='$nama_file_baru', stok='$stok' where id_skincare='$id_skincare'");
